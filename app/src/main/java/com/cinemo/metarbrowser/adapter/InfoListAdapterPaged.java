...
public class InfoListAdapterPaged extends PagedListAdapter<Info,InfoListAdapterPaged.ViewHolder> {

    private ClickListener clickListener;

    public InfoListAdapterPaged(@NonNull DiffCallbackItem diffCallback, ClickListener clickListener) {
        super(diffCallback);
